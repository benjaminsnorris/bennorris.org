...
![Enable safe area layout guides]({{ site.media_url }}/images/posts/enable-safe-area-layout-guides.png){:loading="lazy"}
...
![Constrain to superview]({{ site.media_url }}/images/posts/constrain-to-superview.png){:loading="lazy"}
...
![Constrain to cell]({{ site.media_url }}/images/posts/constrain-to-cell.png){:loading="lazy"}
...
![Gap at bottom]({{ site.media_url }}/images/posts/gap-at-bottom.png){:loading="lazy"}
...
![Extra bottom view]({{ site.media_url }}/images/posts/extra-bottom-view.png){:loading="lazy"}
